...
##
## This is NOT the model retrospective (that is 05_run_retrospective.R, which
...
## 05_run_retrospective.R (lines 422-466) with its missing patchwork dependency
## supplied.
##
## Usage (from the snow_sept repo root):
##   Rscript 05b_plot_historical_bias.R
##
## Output: plots/historical_mating_mmb_est.png
##         (included by the SAFE -- see the 2025 reference Rmd, line 2631)
## ============================================================================
