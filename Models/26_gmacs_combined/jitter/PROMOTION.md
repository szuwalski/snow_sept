...
On 2026-09-17, `05_run_jitter.R` found a jitter run that fit better than the base
fit, and promoted it into this model directory.

- source run      : jitter/054
- seed            : 20260875
- nll before      : -23884.783877
- nll after       : -23885.113292  (improvement 0.329)
- max|grad| before: 0.00505
- max|grad| after : 0.00521
...
The previous fit is in `jitter/base_prepromotion_20260917/`.
